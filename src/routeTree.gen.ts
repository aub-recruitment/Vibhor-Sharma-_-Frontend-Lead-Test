...
const PackagesIndexLazyRoute = PackagesIndexLazyRouteImport.update({
  id: '/packages/',
  path: '/packages/',
  getParentRoute: () => rootRouteImport,
} as any).lazy(() =>
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/packages/$packageName' | '/packages'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/packages/$packageName' | '/packages'
  id: '__root__' | '/' | '/packages/$packageName' | '/packages/'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/packages/': {
      ...
      path: '/packages'
      fullPath: '/packages'
      preLoaderRoute: typeof PackagesIndexLazyRouteImport
      parentRoute: typeof rootRouteImport
    }
